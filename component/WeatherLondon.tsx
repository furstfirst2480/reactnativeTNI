...
const WeatherLondon = ():React.JSX.Element => {
  ...
  const fetchWeatherData = async() =>{
    ...
    const URL = `https://api.openweathermap.org/data/2.5/weather?q=London&appid=${API_KEY}&units=metric&lang=eng`;
  ...
  if (state.error) {
    ...
    <View style={styles.container}>
      ...
      <Text style={styles.weatherDescription}>{state.data.weather[0].description} C</Text>
      <FlatList
      data={[
